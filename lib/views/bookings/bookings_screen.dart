                    ...
                    : Column(
                        children: [
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Expanded(flex: 2, child: Text('Vehicle Number', style: TextStyle(fontWeight: FontWeight.w600, color: ColorPalette.textSecondary, fontSize: context.sp(14)))),
                                Expanded(flex: 2, child: Text('Vehicle Name', style: TextStyle(fontWeight: FontWeight.w600, color: ColorPalette.textSecondary, fontSize: context.sp(14)))),
                                Expanded(flex: 2, child: Text('Customer Name', style: TextStyle(fontWeight: FontWeight.w600, color: ColorPalette.textSecondary, fontSize: context.sp(14)))),
                                Expanded(flex: 2, child: Text('Status', style: TextStyle(fontWeight: FontWeight.w600, color: ColorPalette.textSecondary, fontSize: context.sp(14)))),
                              ],
                            ),
                          ),
                          const Divider(),
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return InkWell(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Expanded(flex: 2, child: Text(booking.vehicle.number, style: TextStyle(fontWeight: FontWeight.w500, fontSize: context.sp(14)))),
